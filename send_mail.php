...
try {
    ...
    //Recipients
    $mail->setFrom('olaoladapo007@gmail.com', 'Ola Oladapo');         //Set the sender of the message (your email address)
    $mail->addAddress('mary.isiekwene@tek-experts.com', 'Mary Isiekwene');     //Add a recipient (your bae's email address)
